...
class ConflictException extends DioError {
  ConflictException({required RequestOptions requestOptions}) : super(requestOptions: requestOptions);
  @override
  String toString() {    
...
class NotFoundExpection extends DioError {
  NotFoundExpection({required RequestOptions requestOptions}) : super(requestOptions: requestOptions);
  @override
  String toString() {    
...
class NoInternetConnectionException extends DioError {
  NoInternetConnectionException({required RequestOptions requestOptions}) : super(requestOptions: requestOptions);
...
class DeadLineExceedException  extends DioError{
  DeadLineExceedException({required RequestOptions requestOptions}) : super(requestOptions: requestOptions);
